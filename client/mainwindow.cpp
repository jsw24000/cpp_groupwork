    ...
    , ui(new Ui::MainWindow)
{
    ...
    setIcon(30, ui->refreshButton, ":/icon/retry.png");
    ui->refreshButton->setCursor(Qt::PointingHandCursor);
    setIcon(30, ui->searchButton, ":/icon/search.png");
    ui->searchButton->setCursor(Qt::PointingHandCursor);

    QStringList options = {"绿茵", "日出", "末日", "海滩", "山雾", "水彩"};
    ui->backgroundBox->addItems(options);

    // 设置背景
    setBackground(":/image/bg1.jpg");
...
void MainWindow::addPostToFavorites(const QString &content, const QString &fileName)
{
    ...
    postWidget->setTextEditSize(360, 61); // 这里的宽高可以根据需要调整
...
void MainWindow::on_backgroundBox_editTextChanged(const QString &arg1)
{
    if(arg1 == "绿茵") setBackground(":/image/bg1.jpg");
    else if(arg1 == "日出") setBackground(":/image/bg2.jpg");
    else if(arg1 == "末日") setBackground(":/image/bg3.jpg");
    else if(arg1 == "海滩") setBackground(":/image/bg4.jpg");
    else if(arg1 == "山雾") setBackground(":/image/bg5.jpg");
    else if(arg1 == "水彩") setBackground(":/image/bg6.jpg");
}
